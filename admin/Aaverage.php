...
// Check if the session variable for the average quiz is set
if (!isset($_SESSION['current_question_average'])) {
    $_SESSION['current_question_average'] = 0; // Set default value for average quiz if not set
}

// Fetch questions for the average quiz (stars_value = 2)
$questionQuery = "SELECT * FROM questions WHERE stars_value = 2 ORDER BY id ASC LIMIT 1 OFFSET {$_SESSION['current_question_average']}";
...
if (!$question) {
    ...
    echo 'No more questions available in the Average quiz. <a href="Achallenge.php"><button>Go Back</button></a>';
    exit();
}
    ...
    <script>
        ...
        function checkAnswer(selectedChoice) {
            ...
            if (selectedChoice == correctChoice) {
                popup.innerHTML = '<span class="correct">Correct! +2⭐</span><br>Tap to proceed...';
                popup.style.display = "block";
                popup.onclick = function() {
                    window.location.href = "nextQAaverage.php";
                };
            } else {
...
<body>
    ...
    <div class="quiz-container">
        ...
        <div class="choices">
            ...
            <button class="choice-btn3" id="choice3" data-choice="3" onclick="checkAnswer(3)"><h2><?php echo $choice3; ?></h2></button> <!-- Fix: Added id "choice3" -->
        </div>
    </div>
